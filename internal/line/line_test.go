...
func TestTheoreticalMinStations(t *testing.T) {
	...
	// Total = 57, cycle = 20 => ceil(57/20) = 3.
...
func TestRPWBalance(t *testing.T) {
	g := makeTestTaskGraph()
	// Total task time = 35, takt 18 => at least ceil(35/18)=2 stations.
	...
	// No station should exceed cycle time.
...
func TestMoodieYoungPhase2Improves(t *testing.T) {
	...
	// Phase 2 should not worsen the solution.
...
func TestRPWAnalyze(t *testing.T) {
	g := makeTestTaskGraph()
	// demand=400/shift, avail=28800s => takt=72.
	...
	// Total time = 35, takt = 72 => 1 station is enough.
	if res.StationCount != 1 {
