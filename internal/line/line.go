// Package line models production-line balancing: given a set of tasks (each
// with a processing time) and a required production rate, it computes the takt
// time and assigns tasks to stations using various heuristics (greedy best-fit,
// RPW, Kilbridge-Wester, Moodie-Young, and dual-sided), reporting the
// bottleneck station and overall line efficiency.
package line
...
// TheoreticalMinStations returns the theoretical minimum number of stations
// needed: ceil(totalTaskTime / cycleTime).
